...
const generateEmailContent = (data:any)=>{
  ...
  const htmlData =Object.entries(data).reduce((str,[key,val])=> str += `<h1 class="form-heading" align="left">${CONTACT_MESSAGE_FIELDS[key]}</h1><p class="form-answer" align="left">${val}</p>`, "")
